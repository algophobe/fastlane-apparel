  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div className="relative border-2 border-dashed rounded-2xl p-8 text-center transition-colors border-[var(--border)] hover:border-white/20">
          <input
            type="file"
            accept="image/*"
            onChange={(e) =>
          ...
          {file ? (
            ...
            <div>
              ...
              <p className="text-sm font-body text-[var(--text-secondary)]">
                Drop screenshot here or tap to
                upload
              </p>
            </div>
          )}
